...
import ChatBot from '~~/components/assistant/ChatBot.vue';
...
<template>
        ...
        <perfect-scrollbar class="scrollnavbar">
            <v-list class="pa-6">
                ...
                <template v-for="(item, i) in sidebarMenu">
                    ...
                    <!---Single Item-->
                    <LayoutFullVerticalSidebarNavItem :item="item" v-if="!item.header" class="leftPadding" />
                    <!---End Single Item-->
                </template>
            </v-list>
        </perfect-scrollbar>
    ...
    <v-app-bar elevation="0" class="assistant-chatbot" height="100">
        <AssistantChatBot />
    </v-app-bar>
</template>
